...
public class popup extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode ==PICK_IMAGE || requestCode==RESULT_OK || data.getData()!=null){
            ...
            Toast.makeText(popup.this, "fail", Toast.LENGTH_SHORT).show();
    ...
    private void userdata() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(popup.this, "failed to upload", Toast.LENGTH_SHORT).show();

            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(popup.this, "uploaded successfully", Toast.LENGTH_SHORT).show();
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(android.location.Location location) {
                ...
                Geocoder geocoder = new Geocoder(popup.this, Locale.getDefault());
                try {
